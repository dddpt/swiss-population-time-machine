...
# whole switzerland anciennes communes
url_AC="https://beta.hls-dhs-dss.ch/Search/category?text=*&sort=hls.title_sortString&sortOrder=asc&collapsed=true&r=1&f_hls.lexicofacet_string=2%2F006800.006900.007200."
...
url2de_AC_CH = "https://beta.hls-dhs-dss.ch/search/category?text=*&sort=hls.title_sortString&sortOrder=asc&collapsed=true&r=1&f_hls.lexicofacet_string=2%2F006800.006900.007200.&rows=100&firstIndex="

communes_list = {}
communes_page_url = url2de_AC_CH+"0"
...
for i in range(0,math.ceil(communes_count/100)+1):
    ...
    communes_page_url = url2de_AC_CH+str(i*100)
    communes_page = r.get(communes_page_url)
    tree = html.fromstring(communes_page.content)
...
import json
with open('../1_pop_cleaning/anciennes_communes_CH.json', 'w') as fp:
